...
def test6
  ...
  # String replacement
  t6_1 = lsystem "1", {"1"=>"2", "2"=>"3", "3"=>"1"}, 4, nil
  assert_equal(t6_1,["2", "3", "1", "2"])

  # Regexp with '' eval syntax
  t6z_1 = zparse "q1 e1234", rules: {/(?<=q)[0-9]/=>"'$+1'"}, gen: 3
  t6_2 = zparams(t6z_1, :degree)
  assert_equal(t6_2,[4, 1, 2, 3, 4])

  # Regexp with lambda
  t6z_2 = zparse "q1 e3 q4", gen: 3, rules: {
