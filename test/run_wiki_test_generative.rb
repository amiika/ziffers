...
def test_generative
  ...
  with_random_seed 2353 do
    ...
    a = zparse "a (0..3*(1,7)) h ((0,2)..2*(1,9)) a (0..3*(-7,-5))", synth: :piano, key: :c4, scale: :minor
...
def test_effects
  ...
  a = zparse "q 1 1 2 3 4 5 6 7", pan: tweak(:quint,-1,1,7).ring.mirror
  a = zparse "q 2 1 2 3 4 5 6 7", release: tweak(:quint,0.1,0.5,7).ring.mirror, synth: :piano
  a = zparse "q 3 1 2 3 4 5 6 7", pan: tweak(:cubic,-1,1,10).ring
  a = zparse "q 4 1 2 3 4 5 6 7", amp: tweak(:expo,0,2,10).ring.mirror
